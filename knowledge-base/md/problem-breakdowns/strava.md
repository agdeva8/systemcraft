...
redis.zrange(f"leaderboard:run:global", 0, -1, desc=True, withscores=True)
```

- For time range filtering, we have a more sophisticated approach that combines both sorted sets and hashes:
